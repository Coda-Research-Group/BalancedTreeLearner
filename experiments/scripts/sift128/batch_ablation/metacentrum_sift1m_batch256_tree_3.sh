#!/bin/bash
#PBS -N batl_sift1m_b256_t3
#PBS -l select=1:ncpus=6:mem=16gb:scratch_local=50gb
#PBS -l walltime=20:00:00
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/sift1m_batch256_tree_3.log
#PBS -m abe
#PBS -M 536343@mail.muni.cz

# S0 treatment arm, tree 3 of 4. Batch 256 is the SPEC default; the wrappers
