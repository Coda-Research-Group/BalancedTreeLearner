#!/bin/bash
#PBS -N batl_d100m_lbl_build_subset_1pct
#PBS -l select=1:ncpus=16:ngpus=1:gpu_mem=16gb:mem=300gb:scratch_local=200gb
#PBS -l walltime=12:00:00
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/deep100m_label_build_subset_1pct.log
#PBS -m abe
#PBS -M 536343@mail.muni.cz

# Baseline: the inherited 1%-of-N subset. Labels approximate rank-10,000
# true neighbours. Mining ~0.3 min/cycle.
