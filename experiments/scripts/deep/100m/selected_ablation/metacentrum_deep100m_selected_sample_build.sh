#!/bin/bash
#PBS -N batl_d100m_sel_sample
#PBS -J 0-7
#PBS -l select=1:ncpus=16:ngpus=1:gpu_mem=16gb:mem=300gb:scratch_ssd=200gb
#PBS -l walltime=24:00:00
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/deep100m_selected_sample_build^array_index^.log
#PBS -m abe
...
NEIGHBOR_SEARCH_SUBSET="${SAMPLE_VALUES[$ARM_INDEX]}"
