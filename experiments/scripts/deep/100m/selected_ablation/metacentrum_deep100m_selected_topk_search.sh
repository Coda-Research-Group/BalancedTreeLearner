#!/bin/bash
#PBS -N batl_d100m_sel_topk_s
#PBS -J 0-2
#PBS -l select=1:ncpus=8:ngpus=1:gpu_mem=16gb:mem=150gb:scratch_ssd=200gb
#PBS -l walltime=6:00:00
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/deep100m_selected_topk_search^array_index^.log
#PBS -m abe
...
TOP_K_NEIGHBORS="${TOP_K_VALUES[$ARRAY_INDEX]}"
