#!/bin/bash
#PBS -N batl_d100m_sel_base
#PBS -J 0-3
#PBS -l select=1:ncpus=16:ngpus=1:gpu_mem=16gb:mem=300gb:scratch_ssd=200gb
#PBS -l walltime=24:00:00
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/deep100m_selected_baseline_build^array_index^.log
#PBS -m abe
#PBS -M 536343@mail.muni.cz

set -u
ARM_NAME=baseline
TREE_INDEX="${PBS_ARRAY_INDEX:?PBS_ARRAY_INDEX is required}"
NUM_TREES=4
