#!/bin/bash
#PBS -N batl_laion_clip768_10m_b300
# Merge the four independently trained LAION-2B CLIP768v2 trees, then run the
# versioned beam-300 recall/QPS sweep. Submit only after all four tree jobs succeed.
#PBS -l select=1:ncpus=16:ngpus=1:gpu_mem=16gb:gpu_cap=sm_89:cluster=fobos:mem=128gb:scratch_local=100gb
#PBS -l walltime=12:00:00
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/laion_clip768_10m_beam300_search.log
#PBS -m abe
#PBS -M 536343@mail.muni.cz

set -euo pipefail

RESULT_NAME="laion_clip768v2_10m_gpu_t4_beam300_search"
...
BUILD_CONFIG_RELATIVE="experiments/configs/laion5b/laion5b_10m_clip768v2_lmi.yaml"
SEARCH_CONFIG_RELATIVE="experiments/configs/laion5b/laion5b_10m_clip768v2_lmi_beam300.yaml"
JOB_RELATIVE="experiments/scripts/laion5b/metacentrum_laion_clip768v2_10m_gpu_beam300_search.sh"
