#!/bin/bash
#PBS -N batl_laion_clip768_10m_tree_3
# Build tree 3 of the T=4 BATL ensemble on the exact SISAP 2023
...
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/laion_clip768_10m_tree_3.log
#PBS -m abe
...
TREE_INDEX=3
JOB_RELATIVE="experiments/scripts/laion5b/metacentrum_laion_clip768v2_10m_gpu_tree_3.sh"
