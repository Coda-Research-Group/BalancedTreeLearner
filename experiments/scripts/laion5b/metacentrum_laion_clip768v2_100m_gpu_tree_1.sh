#!/bin/bash
#PBS -N batl_laion_clip768_100m_tree_1
# Build tree 1 of the exact SISAP 2023 LAION CLIP768v2 100M T=4 index.
...
#PBS -j oe
#PBS -o /auto/brno2/home/jozefsprlak/logs/batl/laion_clip768_100m_tree_1.log
#PBS -m abe
...
TREE_INDEX=1
JOB_RELATIVE="experiments/scripts/laion5b/metacentrum_laion_clip768v2_100m_gpu_tree_1.sh"
